...
* `TIKTOK_INTEGRATION` (value: `'tiktok_integration'`)
...
* `ATLASSIAN_OAUTH_INTEGRATION` (value: `'atlassian_oauth_integration'`)
...
* `ZOHO_INTEGRATION` (value: `'zoho_integration'`)

* `TELEGRAM_INTEGRATION` (value: `'telegram_integration'`)

* `AIRTABLE_INTEGRATION` (value: `'airtable_integration'`)

* `WIX_INTEGRATION` (value: `'wix_integration'`)

* `CHAMELEOON_INTEGRATION` (value: `'chameleoon_integration'`)

* `NOTION_INTEGRATION` (value: `'notion_integration'`)

* `ABRA_INTEGRATION` (value: `'abra_integration'`)

* `ZENDESK_INTEGRATION` (value: `'zendesk_integration'`)

* `GITLAB_INTEGRATION` (value: `'gitlab_integration'`)
...
* `GOOGLE_BIGQUERY_INTEGRATION` (value: `'google_bigquery_integration'`)

* `GOOGLE_ANALYTICS_INTEGRATION` (value: `'google_analytics_integration'`)
