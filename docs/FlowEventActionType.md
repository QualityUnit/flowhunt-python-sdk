...
* `AGENT_COT` (value: `'agent_cot'`)

* `TODO_LIST` (value: `'todo_list'`)

* `ATTACHMENT` (value: `'attachment'`)

* `V3_TOOL_CALL_START` (value: `'v3_tool_call_start'`)

* `V3_TOOL_CALL_END` (value: `'v3_tool_call_end'`)

* `V3_FLOW_ASSISTANT_INIT` (value: `'v3_flow_assistant_init'`)
