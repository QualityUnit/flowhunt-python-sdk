...
[**delete_agent_grid_row**](AgentGridsApi.md#delete_agent_grid_row) | **DELETE** /v2/agent_grids/{agent_grid_id}/rows/{row_id} | Delete a row
...
[**import_agent_grid_csv**](AgentGridsApi.md#import_agent_grid_csv) | **POST** /v2/agent_grids/{agent_grid_id}/import-csv | Import CSV
...
[**search_agent_grids**](AgentGridsApi.md#search_agent_grids) | **POST** /v2/agent_grids/search | Search Flow Tables
...
# **delete_agent_grid_row**
> Completed delete_agent_grid_row(agent_grid_id, row_id, workspace_id)
...
with flowhunt.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete a row
        api_response = api_instance.delete_agent_grid_row(agent_grid_id, row_id, workspace_id)
        print("The response of AgentGridsApi->delete_agent_grid_row:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AgentGridsApi->delete_agent_grid_row: %s\n" % e)
```
...
# **import_agent_grid_csv**
> AgentGridImportStartResponse import_agent_grid_csv(agent_grid_id, workspace_id, file)
...
with flowhunt.ApiClient(configuration) as api_client:
    ...
    agent_grid_id = 'agent_grid_id_example' # str | 
    workspace_id = 'workspace_id_example' # str | 
    file = 'file_example' # str | CSV file to import

    try:
        # Import CSV
        api_response = api_instance.import_agent_grid_csv(agent_grid_id, workspace_id, file)
        print("The response of AgentGridsApi->import_agent_grid_csv:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AgentGridsApi->import_agent_grid_csv: %s\n" % e)
```
...
# **search_agent_grids**
> List[AgentGridResponse] search_agent_grids(workspace_id, agent_grid_search_list_request)
...
with flowhunt.ApiClient(configuration) as api_client:
    ...
    api_instance = flowhunt.AgentGridsApi(api_client)
    workspace_id = 'workspace_id_example' # str | 
    agent_grid_search_list_request = flowhunt.AgentGridSearchListRequest() # AgentGridSearchListRequest | 

    try:
        # Search Flow Tables
        api_response = api_instance.search_agent_grids(workspace_id, agent_grid_search_list_request)
        print("The response of AgentGridsApi->search_agent_grids:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AgentGridsApi->search_agent_grids: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **workspace_id** | **str**|  | 
 **agent_grid_search_list_request** | [**AgentGridSearchListRequest**](AgentGridSearchListRequest.md)|  | 
