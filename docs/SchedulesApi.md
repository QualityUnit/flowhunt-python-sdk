...
# **delete_schedule_url**
> Completed delete_schedule_url(schedule_id, url_id, domain_id, workspace_id, schedule_url_delete_request)
...
with flowhunt.ApiClient(configuration) as api_client:
    ...
    workspace_id = 'workspace_id_example' # str | 
    schedule_url_delete_request = flowhunt.ScheduleUrlDeleteRequest() # ScheduleUrlDeleteRequest | 

    try:
        # Delete Schedule Url
        api_response = api_instance.delete_schedule_url(schedule_id, url_id, domain_id, workspace_id, schedule_url_delete_request)
        print("The response of SchedulesApi->delete_schedule_url:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SchedulesApi->delete_schedule_url: %s\n" % e)
```
 ...
 **domain_id** | **str**|  | 
 **workspace_id** | **str**|  | 
 **schedule_url_delete_request** | [**ScheduleUrlDeleteRequest**](ScheduleUrlDeleteRequest.md)|  | 
