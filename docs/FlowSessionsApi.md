...
[**get_chart_feedback**](FlowSessionsApi.md#get_chart_feedback) | **POST** /v2/chatbots/sessions/charts | Get Chart Feedback
[**get_chart_session_duration**](FlowSessionsApi.md#get_chart_session_duration) | **POST** /v2/chatbots/sessions/chart_session_duration | Get Chart Session Duration
...
[**get_tool_calls_chart_feedback**](FlowSessionsApi.md#get_tool_calls_chart_feedback) | **POST** /v2/chatbots/sessions/chart_tool_calls | Get Tool Calls Chart Feedback
...
[**search_flow_event**](FlowSessionsApi.md#search_flow_event) | **POST** /v2/chatbots/sessions/search_event | Search Flow Event
...
# **get_chart_feedback**
> FeedbackChartResponse get_chart_feedback(workspace_id, charts_feedback_request)
...
with flowhunt.ApiClient(configuration) as api_client:
    ...
    api_instance = flowhunt.FlowSessionsApi(api_client)
    workspace_id = 'workspace_id_example' # str | 
    charts_feedback_request = flowhunt.ChartsFeedbackRequest() # ChartsFeedbackRequest | 

    try:
        # Get Chart Feedback
        api_response = api_instance.get_chart_feedback(workspace_id, charts_feedback_request)
        print("The response of FlowSessionsApi->get_chart_feedback:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowSessionsApi->get_chart_feedback: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **workspace_id** | **str**|  | 
 **charts_feedback_request** | [**ChartsFeedbackRequest**](ChartsFeedbackRequest.md)|  | 

### Return type

[**FeedbackChartResponse**](FeedbackChartResponse.md)
...
# **get_chart_session_duration**
> ChartSessionDurationResponse get_chart_session_duration(workspace_id, charts_feedback_request)
...
with flowhunt.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Chart Session Duration
        api_response = api_instance.get_chart_session_duration(workspace_id, charts_feedback_request)
        print("The response of FlowSessionsApi->get_chart_session_duration:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowSessionsApi->get_chart_session_duration: %s\n" % e)
```
...
[**ChartSessionDurationResponse**](ChartSessionDurationResponse.md)
...
# **get_tool_calls_chart_feedback**
> List[ToolCallFeedbackResponse] get_tool_calls_chart_feedback(workspace_id, charts_feedback_request)
...
with flowhunt.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Tool Calls Chart Feedback
        api_response = api_instance.get_tool_calls_chart_feedback(workspace_id, charts_feedback_request)
        print("The response of FlowSessionsApi->get_tool_calls_chart_feedback:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowSessionsApi->get_tool_calls_chart_feedback: %s\n" % e)
```
...
[**List[ToolCallFeedbackResponse]**](ToolCallFeedbackResponse.md)
...
# **search_flow_event**
> List[FlowEventsSearchResponse] search_flow_event(workspace_id, flow_events_search_request)
...
with flowhunt.ApiClient(configuration) as api_client:
    ...
    api_instance = flowhunt.FlowSessionsApi(api_client)
    workspace_id = 'workspace_id_example' # str | 
    flow_events_search_request = flowhunt.FlowEventsSearchRequest() # FlowEventsSearchRequest | 

    try:
        # Search Flow Event
        api_response = api_instance.search_flow_event(workspace_id, flow_events_search_request)
        print("The response of FlowSessionsApi->search_flow_event:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowSessionsApi->search_flow_event: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **workspace_id** | **str**|  | 
 **flow_events_search_request** | [**FlowEventsSearchRequest**](FlowEventsSearchRequest.md)|  | 

### Return type

[**List[FlowEventsSearchResponse]**](FlowEventsSearchResponse.md)
