...
**created_at** | **float** | Creation date of the document (timestamp) | [optional] [default to 1.774363221572529E9]
...
**page_numbers** | **List[int]** | Page numbers parallel to content array (for PDF documents) | [optional] 
