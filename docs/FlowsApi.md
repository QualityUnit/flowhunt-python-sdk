...
[**get_artefact_content**](FlowsApi.md#get_artefact_content) | **GET** /v2/flows/sessions/{session_id}/artefacts/{artefact_id} | Get artefact content
...
[**resume_hook**](FlowsApi.md#resume_hook) | **POST** /v2/flows/sessions/{session_id}/resume-hook | Resume Hook
...
with flowhunt.ApiClient(configuration) as api_client:
    ...
    try:
        # Cancel Flow Session
        api_response = api_instance.cancel_flow_session(session_id)
        print("The response of FlowsApi->cancel_flow_session:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowsApi->cancel_flow_session: %s\n" % e)
```
...
# **download_attachment**
> object download_attachment(session_id, file_id)
...
with flowhunt.ApiClient(configuration) as api_client:
    ...
    try:
        # Download attachment
        api_response = api_instance.download_attachment(session_id, file_id)
        print("The response of FlowsApi->download_attachment:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowsApi->download_attachment: %s\n" % e)
```
...
# **get_artefact_content**
> FlowSessionArtefactContentResponse get_artefact_content(session_id, artefact_id)
...
with flowhunt.ApiClient(configuration) as api_client:
    ...
    api_instance = flowhunt.FlowsApi(api_client)
    session_id = 'session_id_example' # str | 
    artefact_id = 'artefact_id_example' # str | 

    try:
        # Get artefact content
        api_response = api_instance.get_artefact_content(session_id, artefact_id)
        print("The response of FlowsApi->get_artefact_content:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowsApi->get_artefact_content: %s\n" % e)
```
...
[**FlowSessionArtefactContentResponse**](FlowSessionArtefactContentResponse.md)
...
# **resume_hook**
> Completed resume_hook(session_id, flow_session_resume_hook_request)
...
with flowhunt.ApiClient(configuration) as api_client:
    ...
    api_instance = flowhunt.FlowsApi(api_client)
    session_id = 'session_id_example' # str | 
    flow_session_resume_hook_request = flowhunt.FlowSessionResumeHookRequest() # FlowSessionResumeHookRequest | 

    try:
        # Resume Hook
        api_response = api_instance.resume_hook(session_id, flow_session_resume_hook_request)
        print("The response of FlowsApi->resume_hook:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FlowsApi->resume_hook: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **session_id** | **str**|  | 
 **flow_session_resume_hook_request** | [**FlowSessionResumeHookRequest**](FlowSessionResumeHookRequest.md)|  | 
