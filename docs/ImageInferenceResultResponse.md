...
------------ | ------------- | ------------- | -------------
**result** | [**ImageInferenceResponse**](ImageInferenceResponse.md) | The list of inference results | [optional] 
**status** | **str** | Whether the inference is completed | 
**error_message** | **str** | The error message if the inference failed | [optional] 
