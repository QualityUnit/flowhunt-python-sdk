...
------------- | ------------- | -------------
[**delete_jira_webhook**](AtlassianApi.md#delete_jira_webhook) | **DELETE** /v2/integrations/atlassian/jira/webhooks/{webhook_id} | Delete Jira Webhook
...
[**list_jira_webhooks**](AtlassianApi.md#list_jira_webhooks) | **GET** /v2/integrations/atlassian/jira/webhooks | List Jira Webhooks
...
with flowhunt.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling AtlassianApi->delete_jira_webhook: %s\n" % e)
```
...
with flowhunt.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of AtlassianApi->list_jira_webhooks:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AtlassianApi->list_jira_webhooks: %s\n" % e)
```
