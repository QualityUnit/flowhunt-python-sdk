...
[**optimize_prompt**](PromptsApi.md#optimize_prompt) | **POST** /v2/prompts/optimize | Optimize Prompt
...
# **optimize_prompt**
> OptimizedPromptResponse optimize_prompt(workspace_id, prompt_optimizer_request)
...
with flowhunt.ApiClient(configuration) as api_client:
    ...
    api_instance = flowhunt.PromptsApi(api_client)
    workspace_id = 'workspace_id_example' # str | 
    prompt_optimizer_request = flowhunt.PromptOptimizerRequest() # PromptOptimizerRequest | 

    try:
        # Optimize Prompt
        api_response = api_instance.optimize_prompt(workspace_id, prompt_optimizer_request)
        print("The response of PromptsApi->optimize_prompt:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PromptsApi->optimize_prompt: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **workspace_id** | **str**|  | 
 **prompt_optimizer_request** | [**PromptOptimizerRequest**](PromptOptimizerRequest.md)|  | 

### Return type

[**OptimizedPromptResponse**](OptimizedPromptResponse.md)
