...
**country** | **str** | Country to search | [optional] 
**location** | **str** | Location to search | [optional] 
**language** | **str** | Language to search | [optional] 
**count_urls** | **int** | Number of urls to search. Possible values are 10 and 100. | [optional] 
