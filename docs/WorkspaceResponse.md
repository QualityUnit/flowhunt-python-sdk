...
**auto_recharge_enabled** | **bool** | Whether auto-recharge is enabled for this workspace. | [optional] [default to False]
**auto_recharge_threshold** | **int** | Credit balance threshold that triggers an auto-recharge. | [optional] 
**auto_recharge_amount** | **int** | Credits added to the workspace when auto-recharge triggers. | [optional] 
