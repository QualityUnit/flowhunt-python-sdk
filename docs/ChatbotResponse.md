...
**max_window_height** | **str** | Max window height | [optional] 
...
**primary_color** | **str** | Primary color for global theme in hexadecimal | [optional] 
**text_color** | **str** | Text color for global theme in hexadecimal | [optional] 
...
**show_embed_close_button** | **bool** | Whether to show a close button in the embedded chatbot header | [optional] 
...
**language** | **str** | Language code for chatbot UI and loading indicators (ISO 639-1) | [optional] 
**max_input_characters** | **int** | Maximum number of characters allowed in a single chat message input (null &#x3D; unlimited) | [optional] 
