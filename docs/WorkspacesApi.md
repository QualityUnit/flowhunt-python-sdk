...
[**transfer_workspace_ownership**](WorkspacesApi.md#transfer_workspace_ownership) | **POST** /v2/workspaces/{workspace_id}/transfer-ownership/{new_owner_user_id} | Transfer Workspace Ownership
[**update_workspace**](WorkspacesApi.md#update_workspace) | **PUT** /v2/workspaces/{workspace_id} | Update Workspace
[**update_workspace_auto_recharge**](WorkspacesApi.md#update_workspace_auto_recharge) | **PUT** /v2/workspaces/{workspace_id}/auto-recharge | Update Workspace Auto Recharge
[**update_workspace_credit_alert_threshold**](WorkspacesApi.md#update_workspace_credit_alert_threshold) | **PUT** /v2/workspaces/{workspace_id}/credit-alert-threshold | Update Workspace Credit Alert Threshold
[**update_workspace_credit_limit**](WorkspacesApi.md#update_workspace_credit_limit) | **PUT** /v2/workspaces/{workspace_id}/credit-limit | Update Workspace Credit Limit
...
with flowhunt.ApiClient(configuration) as api_client:
    ...
    api_instance = flowhunt.WorkspacesApi(api_client)
    workspace_id = 'workspace_id_example' # str | 
    workspace_user_create_request = flowhunt.WorkspaceUserCreateRequest() # WorkspaceUserCreateRequest | 
...
with flowhunt.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = flowhunt.WorkspacesApi(api_client)
    workspace_create_request = flowhunt.WorkspaceCreateRequest() # WorkspaceCreateRequest | 
...
with flowhunt.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = flowhunt.WorkspacesApi(api_client)
    workspace_search_request = flowhunt.WorkspaceSearchRequest() # WorkspaceSearchRequest | 
...
with flowhunt.ApiClient(configuration) as api_client:
    ...
    api_instance = flowhunt.WorkspacesApi(api_client)
    workspace_id = 'workspace_id_example' # str | 
    workspace_users_search_request = flowhunt.WorkspaceUsersSearchRequest() # WorkspaceUsersSearchRequest | 
...
> Completed transfer_workspace_ownership(workspace_id, new_owner_user_id)

Transfer Workspace Ownership

Transfer workspace ownership from current owner to another user.
Only workspace owners and sudoers can perform this action.
The old owner will become an Administrator.
...
with flowhunt.ApiClient(configuration) as api_client:
    ...
    api_instance = flowhunt.WorkspacesApi(api_client)
    workspace_id = 'workspace_id_example' # str | 
    new_owner_user_id = 'new_owner_user_id_example' # str | 

    try:
        # Transfer Workspace Ownership
        api_response = api_instance.transfer_workspace_ownership(workspace_id, new_owner_user_id)
        print("The response of WorkspacesApi->transfer_workspace_ownership:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WorkspacesApi->transfer_workspace_ownership: %s\n" % e)
```
...
with flowhunt.ApiClient(configuration) as api_client:
    ...
    api_instance = flowhunt.WorkspacesApi(api_client)
    workspace_id = 'workspace_id_example' # str | 
    workspace_update_request = flowhunt.WorkspaceUpdateRequest() # WorkspaceUpdateRequest | 
...
# **update_workspace_auto_recharge**
> WorkspaceResponse update_workspace_auto_recharge(workspace_id, workspace_auto_recharge_request)

Update Workspace Auto Recharge

Update the auto-recharge settings for a workspace.

When enabled, the workspace is automatically topped up with ``amount`` credits
whenever the available balance drops below ``threshold``. Requires a paid
subscription plan with a payment method on file. Only workspace owners and
admins can update this setting.
...
with flowhunt.ApiClient(configuration) as api_client:
    ...
    api_instance = flowhunt.WorkspacesApi(api_client)
    workspace_id = 'workspace_id_example' # str | 
    workspace_auto_recharge_request = flowhunt.WorkspaceAutoRechargeRequest() # WorkspaceAutoRechargeRequest | 

    try:
        # Update Workspace Auto Recharge
        api_response = api_instance.update_workspace_auto_recharge(workspace_id, workspace_auto_recharge_request)
        print("The response of WorkspacesApi->update_workspace_auto_recharge:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WorkspacesApi->update_workspace_auto_recharge: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **workspace_id** | **str**|  | 
 **workspace_auto_recharge_request** | [**WorkspaceAutoRechargeRequest**](WorkspaceAutoRechargeRequest.md)|  | 
...
# **update_workspace_credit_alert_threshold**
> WorkspaceResponse update_workspace_credit_alert_threshold(workspace_id, workspace_credit_alert_threshold_request)

Update Workspace Credit Alert Threshold

Update the credit alert threshold for a workspace.
When the credit balance drops to or below the threshold, email and in-app notifications
are sent. Set credit_alert_threshold to null to use the system default (10% of monthly plan value).
Available to all plan tiers. Only workspace owners and admins can update this setting.
...
with flowhunt.ApiClient(configuration) as api_client:
    ...
    api_instance = flowhunt.WorkspacesApi(api_client)
    workspace_id = 'workspace_id_example' # str | 
    workspace_credit_alert_threshold_request = flowhunt.WorkspaceCreditAlertThresholdRequest() # WorkspaceCreditAlertThresholdRequest | 

    try:
        # Update Workspace Credit Alert Threshold
        api_response = api_instance.update_workspace_credit_alert_threshold(workspace_id, workspace_credit_alert_threshold_request)
        print("The response of WorkspacesApi->update_workspace_credit_alert_threshold:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WorkspacesApi->update_workspace_credit_alert_threshold: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **workspace_id** | **str**|  | 
 **workspace_credit_alert_threshold_request** | [**WorkspaceCreditAlertThresholdRequest**](WorkspaceCreditAlertThresholdRequest.md)|  | 
...
# **update_workspace_credit_limit**
> WorkspaceResponse update_workspace_credit_limit(workspace_id, workspace_credit_limit_request)

Update Workspace Credit Limit

Update the credit consumption limit for a workspace.
Only available for workspace owners with AGENCY or ENTERPRISE subscription plans.
Set credit_limit to null to remove the limit.
...
with flowhunt.ApiClient(configuration) as api_client:
    ...
    api_instance = flowhunt.WorkspacesApi(api_client)
    workspace_id = 'workspace_id_example' # str | 
    workspace_credit_limit_request = flowhunt.WorkspaceCreditLimitRequest() # WorkspaceCreditLimitRequest | 

    try:
        # Update Workspace Credit Limit
        api_response = api_instance.update_workspace_credit_limit(workspace_id, workspace_credit_limit_request)
        print("The response of WorkspacesApi->update_workspace_credit_limit:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling WorkspacesApi->update_workspace_credit_limit: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **workspace_id** | **str**|  | 
 **workspace_credit_limit_request** | [**WorkspaceCreditLimitRequest**](WorkspaceCreditLimitRequest.md)|  | 
...
with flowhunt.ApiClient(configuration) as api_client:
    ...
    workspace_id = 'workspace_id_example' # str | 
    user_id = 'user_id_example' # str | 
    workspace_user_update_request = flowhunt.WorkspaceUserUpdateRequest() # WorkspaceUserUpdateRequest | 
