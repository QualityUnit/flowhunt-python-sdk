...
[**upload_document**](MemoryApi.md#upload_document) | **POST** /v2/memory/upload/{cat_id} | Upload Document
...
# **upload_document**
> MemoryDocumentUploadResponse upload_document(cat_id, workspace_id, file)
...
with flowhunt.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of MemoryApi->upload_document:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MemoryApi->upload_document: %s\n" % e)
```
