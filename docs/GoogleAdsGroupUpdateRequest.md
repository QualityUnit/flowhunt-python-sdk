...
------------ | ------------- | ------------- | -------------
**language_code** | **str** | Language code, if None, value is inherited from campaign | 
**country** | **str** | Country, if None, value is inherited from campaign | 
**action_type** | [**GoogleAdsActionType**](GoogleAdsActionType.md) | Action type, if None, value is inherited from campaign | 
