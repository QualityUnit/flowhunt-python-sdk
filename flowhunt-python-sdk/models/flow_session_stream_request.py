...
class FlowSessionStreamRequest(BaseModel):
    """
    FlowSessionStreamRequest
    """ # noqa: E501
    messages: List[FlowSessionMessage] = Field(description="The flow messages")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "messages": [FlowSessionMessage.from_dict(_item) for _item in obj["messages"]] if obj.get("messages") is not None else None
        })
        return _obj
