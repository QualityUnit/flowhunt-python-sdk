...
class GridColumnResponse(BaseModel):
    """
    GridColumnResponse
    """ # noqa: E501
    ...
    position: StrictInt = Field(description="Position of the column")
    data_type: ColumnDataType = Field(description="Data type of the column")
    data_type_options: Optional[StrictStr] = None
    input_columns: Optional[List[StrictStr]] = None
    executor_type: ColumnExecutorType = Field(description="Executor type of the column")
    executor_flow_id: Optional[StrictStr] = None
    executor_input_template: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["workspace_id", "grid_id", "col_id", "name", "position", "data_type", "data_type_options", "input_columns", "executor_type", "executor_flow_id", "executor_input_template"]
