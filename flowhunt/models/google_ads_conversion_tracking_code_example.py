...
class GoogleAdsConversionTrackingCodeExample(BaseModel):
    """
    GoogleAdsConversionTrackingCodeExample
    """ # noqa: E501
    conversion_action_id: StrictInt = Field(description="The ID of the conversion action")
    conversion_action_name: StrictStr = Field(description="The name of the conversion action")
    ...
    __properties: ClassVar[List[str]] = ["conversion_action_id", "conversion_action_name", "tracking_code", "description"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "conversion_action_name": obj.get("conversion_action_name"),
