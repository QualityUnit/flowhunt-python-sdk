...
class FlowBulkUpdateRequest(BaseModel):
    """
    FlowBulkUpdateRequest
    """ # noqa: E501
    items: Annotated[List[FlowBulkCategoryUpdateItem], Field(max_length=30)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [FlowBulkCategoryUpdateItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
