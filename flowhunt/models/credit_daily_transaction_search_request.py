...
class CreditDailyTransactionSearchRequest(BaseModel):
    ...
    grouping: Optional[GroupingPeriod] = Field(default=None, description="Grouping period: date, week, or month")
    ...
    __properties: ClassVar[List[str]] = ["created_at_from", "created_at_to", "transaction_type", "grouping", "limit", "pagination"]
