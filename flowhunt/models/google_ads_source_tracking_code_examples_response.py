...
class GoogleAdsSourceTrackingCodeExamplesResponse(BaseModel):
    """
    GoogleAdsSourceTrackingCodeExamplesResponse
    """ # noqa: E501
    examples: List[GoogleAdsSourceTrackingCodeExample] = Field(description="List of tracking code examples")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "examples": [GoogleAdsSourceTrackingCodeExample.from_dict(_item) for _item in obj["examples"]] if obj.get("examples") is not None else None
        })
        return _obj
