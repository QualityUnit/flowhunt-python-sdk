...
class ProjectInboxEntryResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "workspace_id", "project_id", "kind", "status", "title", "body", "issue_id", "session_id", "metadata", "created_at", "updated_at"]
