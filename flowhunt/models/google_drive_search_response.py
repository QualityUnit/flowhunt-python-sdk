...
class GoogleDriveSearchResponse(BaseModel):
    ...
    files: List[GoogleDriveFileResponse] = Field(description="Files")
    __properties: ClassVar[List[str]] = ["next_page_token", "files"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "files": [GoogleDriveFileResponse.from_dict(_item) for _item in obj["files"]] if obj.get("files") is not None else None
        })
        return _obj
