...
class Metadata(BaseModel):
    ...
    anyof_schema_9_validator: Optional[FlowAssistantAddComponentMetadata] = None
    # data type: FlowAssistantDeleteComponentMetadata
    anyof_schema_10_validator: Optional[FlowAssistantDeleteComponentMetadata] = None
    # data type: FlowAssistantUpdateComponentMetadata
    anyof_schema_11_validator: Optional[FlowAssistantUpdateComponentMetadata] = None
    # data type: FlowAssistantAddConnectionMetadata
    anyof_schema_12_validator: Optional[FlowAssistantAddConnectionMetadata] = None
    # data type: FlowAssistantDeleteConnectionMetadata
    anyof_schema_13_validator: Optional[FlowAssistantDeleteConnectionMetadata] = None
    # data type: FlowAssistantCreateBlankFlowMetadata
    anyof_schema_14_validator: Optional[FlowAssistantCreateBlankFlowMetadata] = None
    # data type: SystemMessageMetadata
    anyof_schema_15_validator: Optional[SystemMessageMetadata] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[FlowAssistantAddComponentMetadata, FlowAssistantAddConnectionMetadata, FlowAssistantCreateBlankFlowMetadata, FlowAssistantDeleteComponentMetadata, FlowAssistantDeleteConnectionMetadata, FlowAssistantUpdateComponentMetadata, FlowSessionAgentCotMetadata, FlowSessionArtefactsMetadata, FlowSessionLoadingMetadata, FlowSessionMessageFeedbackMetadata, FlowSessionMessageMetadata, FlowSessionTaskResponseMetadata, FlowSessionTodoListMetadata, FlowSessionToolCallMetadata, SystemMessageMetadata]] = None
    else:
