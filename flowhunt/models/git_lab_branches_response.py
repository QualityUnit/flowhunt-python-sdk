...
class GitLabBranchesResponse(BaseModel):
    """
    GitLabBranchesResponse
    """ # noqa: E501
    branches: List[GitLabBranchResponse]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "branches": [GitLabBranchResponse.from_dict(_item) for _item in obj["branches"]] if obj.get("branches") is not None else None
        })
        return _obj
