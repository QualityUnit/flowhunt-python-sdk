...
class GoogleAdsConversionTrackingCodeExamplesResponse(BaseModel):
    """
    GoogleAdsConversionTrackingCodeExamplesResponse
    """ # noqa: E501
    examples: List[GoogleAdsConversionTrackingCodeExample] = Field(description="List of tracking code examples")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "examples": [GoogleAdsConversionTrackingCodeExample.from_dict(_item) for _item in obj["examples"]] if obj.get("examples") is not None else None
        })
        return _obj
