...
class FlowBatchColumnDefinition(BaseModel):
    """
    FlowBatchColumnDefinition
    """ # noqa: E501
    name: StrictStr = Field(description="Column display name")
    key: StrictStr = Field(description="Column variable key (used as flow variable)")
