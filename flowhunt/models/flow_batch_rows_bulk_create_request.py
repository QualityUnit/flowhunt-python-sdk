...
class FlowBatchRowsBulkCreateRequest(BaseModel):
    """
    FlowBatchRowsBulkCreateRequest
    """ # noqa: E501
    rows: List[FlowBatchRowCreateRequest] = Field(description="Rows to add")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rows": [FlowBatchRowCreateRequest.from_dict(_item) for _item in obj["rows"]] if obj.get("rows") is not None else None
        })
        return _obj
