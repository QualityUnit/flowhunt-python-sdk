...
class JiraWebhooksResponse(BaseModel):
    """
    JiraWebhooksResponse
    """ # noqa: E501
    webhooks: List[JiraWebhookResponse]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "webhooks": [JiraWebhookResponse.from_dict(_item) for _item in obj["webhooks"]] if obj.get("webhooks") is not None else None
        })
        return _obj
