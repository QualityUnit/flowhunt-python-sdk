...
class PowerBIWorkspacesResponse(BaseModel):
    ...
    """ # noqa: E501
    workspaces: List[PowerBIWorkspaceResponse]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "workspaces": [PowerBIWorkspaceResponse.from_dict(_item) for _item in obj["workspaces"]] if obj.get("workspaces") is not None else None
        })
        return _obj
