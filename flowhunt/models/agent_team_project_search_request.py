...
class AgentTeamProjectSearchRequest(BaseModel):
    """
    AgentTeamProjectSearchRequest
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Search by name")
    limit: Optional[StrictInt] = Field(default=25, description="Limit results")
    pagination: Optional[Pagination] = Field(default=None, description="Pagination")
    __properties: ClassVar[List[str]] = ["name", "limit", "pagination"]
