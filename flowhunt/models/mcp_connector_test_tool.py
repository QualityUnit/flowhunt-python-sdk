...
class MCPConnectorTestTool(BaseModel):
    """
    ...
    input_schema: Optional[Dict[str, Any]] = Field(default=None, description="JSON schema of the tool's arguments, if available")
