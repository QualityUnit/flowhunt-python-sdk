...
class GoogleDriveFoldersResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "folders": [GoogleDriveFolderResponse.from_dict(_item) for _item in obj["folders"]] if obj.get("folders") is not None else None
        })
        return _obj
