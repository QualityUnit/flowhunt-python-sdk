...
class FlowResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "flow_type", "component_count", "executed_at", "category_id", "enable_cache", "last_modified", "engine_version", "integration_slugs"]
