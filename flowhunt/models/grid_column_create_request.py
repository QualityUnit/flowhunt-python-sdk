...
class GridColumnCreateRequest(BaseModel):
    """
    GridColumnCreateRequest
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the grid column")
    position: StrictInt = Field(description="Position of the grid column")
    data_type: ColumnDataType = Field(description="Data type of the grid column")
    data_type_options: Optional[StrictStr] = None
    input_columns: Optional[List[StrictStr]] = None
    executor_type: ColumnExecutorType = Field(description="Executor type of the grid column")
